/**
 * BLEUART: BLE UART Communication
 * ===============================
 *
 * BLEUART is using UART protocol using BLE, this was originated from Noble Project
 *
 *
 * @module
 * @author Wenpeng Wang <ww2cg@virginia.edu>
 * @display-name BLEUART
 */
...
function* init () {
  //addInputHandler('Button', button_press);
  //var BLE_Uart_mac = getParameter('mac_address', null);
